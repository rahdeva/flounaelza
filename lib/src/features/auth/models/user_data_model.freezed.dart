...
class _$UserDataModelImpl implements _UserDataModel {
  ...
  @override
  String toString() {
    return 'UserDataModel(name: $name, email: $email, phone: $phone, address: $address, image: $image, token: $token)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, email, phone, address, image, token);
...
abstract class _UserDataModel implements UserDataModel {
  const factory _UserDataModel(
      ...
      final String? address,
      final String? image,
      final String? token}) = _$UserDataModelImpl;
